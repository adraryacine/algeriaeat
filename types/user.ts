...
export interface RestaurantProfile extends UserProfile {
  ...
  delivery_zones: string[]; // Wilaya codes
...
// Livreur (Driver) profile
export interface LivreurProfile extends UserProfile {
  role: 'livreur';
  ...
  wilaya: string;
  zones: string[]; // Communes they cover
  bank_details?: BankDetails;
}
...
export interface BankDetails {
  account_type: 'ccp' | 'bank' | 'baridi_mob';
  account_number?: string;
  ccp_key?: string;
  baridi_mob_rip?: string;
  bank_name?: string;
  rib?: string;
}
