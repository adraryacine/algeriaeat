    ...
    <ThemedView style={styles.container}>
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <Animated.View entering={FadeInDown.duration(600).delay(100)} style={styles.tabsContainer}>
          <TouchableOpacity
            ...
            <ThemedText style={[styles.tabText, activeTab === 'menu' && styles.tabTextActive]}>
              Menu
            </ThemedText>
          </TouchableOpacity>
          <TouchableOpacity
            ...
            <ThemedText style={[styles.tabText, activeTab === 'reviews' && styles.tabTextActive]}>
              Avis (24)
            </ThemedText>
          </TouchableOpacity>
          <TouchableOpacity
            ...
            <ThemedText style={[styles.tabText, activeTab === 'info' && styles.tabTextActive]}>
              Infos
            </ThemedText>
          </TouchableOpacity>
        </Animated.View>
          ...
          {menuItems.map((item, index) => (
            <Animated.View
              ...
              <TouchableOpacity
                style={[
                  styles.menuItem,
                  selectedItems.includes(item.id) && styles.menuItemSelected,
                ]}
          ...
          <Animated.View entering={FadeInDown.duration(600).delay(200)} style={styles.reviewsSection}>
            <View style={styles.reviewSummary}>
              <View style={styles.reviewRating}>
                <ThemedText type="title" style={styles.reviewRatingNumber}>4.8</ThemedText>
            ...
            {[1, 2, 3].map((review) => (
              <View key={review} style={styles.reviewItem}>
                ...
                <ThemedText style={styles.reviewText}>
                  Excellent restaurant! Le couscous était délicieux et le service rapide.
                </ThemedText>
              </View>
            ))}
          </Animated.View>
          ...
          <Animated.View entering={FadeInDown.duration(600).delay(200)} style={styles.infoTabSection}>
            <View style={styles.infoCard}>
              ...
              <View style={styles.infoContent}>
                <ThemedText type="defaultSemiBold" style={styles.infoTitle}>Adresse</ThemedText>
            ...
            <View style={styles.infoCard}>
              ...
              <View style={styles.infoContent}>
                <ThemedText type="defaultSemiBold" style={styles.infoTitle}>Téléphone</ThemedText>
            ...
            <View style={styles.infoCard}>
              ...
              <View style={styles.infoContent}>
                <ThemedText type="defaultSemiBold" style={styles.infoTitle}>Horaires</ThemedText>
            ...
            <View style={styles.infoCard}>
              ...
              <View style={styles.infoContent}>
                <ThemedText type="defaultSemiBold" style={styles.infoTitle}>Livraison</ThemedText>
      ...
      {selectedItems.length > 0 && (
        <Animated.View
          ...
          style={[styles.orderBar, { paddingBottom: insets.bottom + 10 }]}>
